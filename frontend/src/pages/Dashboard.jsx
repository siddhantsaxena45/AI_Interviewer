...
function Dashboard() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-12 space-y-8 sm:space-y-12 animate-in fade-in duration-700">
            ...
            {/* --- Session Creation: Grid optimized for Mobile --- */}
                    ...
                    <div className="space-y-4">
                        {sessions.map((session) => (
                            <div key={session._id} 
                                 ...
                                 className="group bg-white border border-slate-100 p-5 sm:p-6 rounded-2xl sm:rounded-[2rem] flex flex-col md:flex-row items-center justify-between gap-4 transition-all hover:shadow-lg active:scale-[0.98] cursor-pointer">
